...
const forecast = (latitute,logitude,callbackfn)=>{
  ...
  request({url, json:true},(error,{body}={})=>{
     ...
     callbackfn(undefined,body.current.weather_descriptions+'.' +"It's currently "+body.current.temperature+" degrees out. It feels like "+body.current.feelslike+" degrees out")
     }
  })
